...
public class Frota {
    ...
    /***
     * Função construtora da classe, ela recebe uma array de veiculos e determina o
     * tamanho da frota pelo array da lista.
     * 
    ...
    /***
     * Função construtora da classe, ela não recebe parametros, inicializando o
     * tamanho da frota com 0 e instanciando o HashMap.
     */
    Frota() {
        tamanhoFrota = 0;
    ...
    /***
     * Função que retorna uma mensagem se foi possivel adicionar o veiculo, ou se o
     * veiculo já tinha sido cadastrado.
     * 
     * @param placa   - Placa do veiculo a ser adicionado
     * @param veiculo - Objeto Veiculo a ser adicionado
     * @return Mensagem informando sucesso ao adicionar ou RuntimeException
     *         informando que não foi possivel.
     */
    ...
    /***
     * Função de tipo Veiculo que retorna o veiculo removido caso, exista, caso
     ...
     * 
     * @return double contendo a soma da quilometragem de todos os veiculos da
     *         frota.
     */
    ...
    /**
     * Função que retorna informações do veiculo com maior quilometragem total
     * percorrida ou mensagem informando
     * que não há veiculos.
     * 
     * @return String contendo o veiculo com maior KM total da frota ou mensagem de
     *         erro.
     */
    ...
    /**
     * Função que retorna informações do veiculo com maior quilometragem média
     * percorrida ou mensagem informando
     * que não há veiculos.
     * 
     * @return String contendo o veiculo com maior KM medio da frota ou mensagem de
     *         erro.
     */
    ...
    /**
     * Função que retorna um objeto veiculo ou lança uma exceção, caso não encontre.
     * Ele recebe uma placa e itera todos os veiculos da frota.
     * 
     * @param placa do veiculo a ser pesquisado.
     * @return objeto Veiculo encontrado ou erro de exceção.
     * @throws NoSuchElementException Caso o veiculo não seja encontrado, o erro é
     *                                propagado.
     */
    ...
    /**
     * Função que retorna se a rota foi adicionada ou não ao veiculo. Ela recebe uma
     * placa e uma rota,
    ...
    /**
     * Função que retorna a quantidade de combustivel consumido pelo veiculo
     * pesquisado. Ela recebe uma placa,
    ...
    /**
     * Função que retorna a quilometragem total percorrida por um veiculo. Ela
     * recebe uma placa,
    ...
    /**
     * Função que retorna a quilometragem total percorrida no mês por um veiculo.
     * Ela recebe uma placa e uma data,
    ...
    public String quilometragemDeVeiculoNoMes(LocalDate data, String placa) throws NoSuchElementException {
        ...
        return "Veiculo de placa: " + placa + " percorreu " + quilometragemMes + " quilômetros no mês ("
                + data.getMonthValue() + ").";
    }

    /**
     * Função que permite adicionar um valor a manutenção dos veículos. Ela recebe
     * uma placa, um ID da manutenção, e um valor.
    ...
    /**
     * Função que retorna o relatorio da frota contendo seu tamanho e informações da
     * lista de veiculos.
     * 
    ...
    /**
     * Função que retorna o relatorio de manutenções de um veiculo. Ela recebe uma
     * placa, pesquisa o veiculo e retorna uma string com o relatorio.
     * 
     * @param placa - Placa do veiculo.
    ...
    /**
     * Função que retorna o relatorio de rotas de um veiculo. Ela recebe uma placa,
     * pesquisa o veiculo e retorna uma string com todas as rotas percorridas.
     * 
     * @param placa - Placa do veiculo.
    ...
    /**
     * Função que retorna o relatorio de despesas de um veiculo. Ela recebe uma
     * placa, pesquisa o veiculo e retorna uma string com o valor gasto em despesas.
     * 
     * @param placa - Placa do veiculo.
    ...
    public String relatorioDespesasDeVeiculo(String placa) throws NoSuchElementException {
        ...
        return veiculoEncontrado.despesasDoVeiculo();
    }
